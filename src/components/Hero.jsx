...
{/* Czy jesteś gotowy, aby przenieść swoje umiejętności Lego Mindstorms na wyższy poziom? Odkryj zaawansowane techniki budowania, wskazówki dotyczące kodowania i zaprezentuj swoje dzieła na naszej stronie internetowej. Tylko niebo ogranicza! */}
    ...
    <div className="yellow-box"><article>Przypominam że na następnych zajęciach 29 listopada sparing Sumo, sprubójcie zaprogramować roboty tak aby walczyły autonomicznie, użyjcie czujnika koloru do wykrycia białej lini, która bedzię przy krawędzi areny.
        ...
        podnoszenia są opcjonalne. </article><article>Przygotuj się na uwolnienie swojej kreatywności i zanurz się z nami w ekscytujący świat robotyki!</article></div>
